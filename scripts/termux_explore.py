...
COMMANDS = [
    ...
    ("uname", "uname -a"),
    ("pwd", "pwd && whoami && id"),
    ("python", "python --version 2>&1; which python"),
    ...
    ("ping_chassis", "ping -c 2 -W 2 10.42.0.1 2>&1 || echo ping chassis échoué"),
    ("rosbridge", "curl -sf -m 3 -o /dev/null -w 'HTTP %{http_code}\\n' http://10.42.0.1:9090 2>&1 || echo rosbridge injoignable"),
