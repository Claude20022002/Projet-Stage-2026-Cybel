...
(H3) explained none of our field outcomes and none of our bench results either, while the
precondition state explained all of them. Establishing that took correcting our own measurement
twice, which is itself the clearest evidence we can offer for H4: on a recovered interface, the
instrument is as easily fooled as the integrator.
