...
others are thin, and the intervals in Table~\ref{tab:metrics} are wide to match. The bench
comparison needs care in particular. Ten trials per arm are enough to exclude a large difference
between the two addressing schemes, and we found none, but they cannot exclude a small one: at
this size the data are equally consistent with the two routes being identical and with one of
them failing a few percent of the time. We claim only the former is not contradicted, not that
equivalence is established. We never instrumented
