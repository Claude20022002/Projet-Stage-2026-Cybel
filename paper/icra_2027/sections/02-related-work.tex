...
Table~\ref{tab:routes} makes the same point from the integrator's side, by asking what each
available route to a control interface presupposes. Bridges and vendor SDKs differ from our
method not in what they deliver but in what they require the vendor to have provided first, and
firmware replacement buys openness at a price a single owned unit cannot pay.

\input{tables/tab-access-routes}
