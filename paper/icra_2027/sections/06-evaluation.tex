...
for both goal-addressing schemes, coordinate goals failing five times and succeeding once, named
annotations failing five times and succeeding six --- the addressing scheme explains nothing, the
precondition state explains everything, and every failed command had been acknowledged.
