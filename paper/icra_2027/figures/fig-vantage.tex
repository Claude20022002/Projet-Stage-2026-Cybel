...
% ground truth. Monochrome line art, matching Fig. 2.
\begin{figure}[!t]
\centering
...
\begin{tikzpicture}[
  ...
  \node[vp] (a) at (0,0)      {Introspection\\\scriptsize names, types};
  \node[vp] (b) at (3.1,0)    {Traffic capture\\\scriptsize framing, order};
  \node[vp] (c) at (6.2,0)    {Application code\\\scriptsize intent, setup};
  ...
  \node[vp, minimum width=6.2cm] (t) at (3.1,-2.3)
