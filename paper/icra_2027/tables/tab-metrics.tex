...
\midrule
Teleoperation success$^{\dagger}$ & 10 & \SI{100}{\percent} & \numrange{72.2}{100}\,\% &
...
Arm A of the H3 comparison: goals addressed by coordinate, preparation omitted \\
Annotation goal, bare client     & 3  & \SI{0}{\percent}   & \numrange{0}{56.2}\,\% &
Arm B: same target and same conditions, and the measurement that redirected H3 towards H4 \\
