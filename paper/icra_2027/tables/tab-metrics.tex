...
Guided tours run end to end          & 7  & --                 & -- &
That the full preparation path works unattended, repeatedly, over seven weeks \\
\quad navigation legs, after map stable & 80 & \SI{100}{\percent} & \numrange{95.4}{100}\,\% &
The same at leg resolution: no navigation failure once the map and its annotations settled \\
\quad navigation legs, before        & 7  & \SI{14.3}{\percent}& \numrange{2.6}{51.3}\,\% &
What the same pipeline did while the map was still changing \\
Tour duration (median)               & 7  & \SI{10.8}{\minute} & \numrange{10.4}{13.1}\,min &
