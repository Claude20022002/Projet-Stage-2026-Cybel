...
export const icons = {
  ...
  refresh: (cls = "icon", size = 16) =>
    svg(
      '<path d="M21 12a9 9 0 0 0-9-9 9 9 0 0 0 6.74 3.01"/><path d="M21 3v6h-6"/>',
      cls,
      size
    ),
  ...
  plus: (cls = "icon", size = 16) =>
    svg('<path d="M12 5v14"/><path d="M5 12h14"/>', cls, size),

  trash: (cls = "icon", size = 16) =>
    svg(
